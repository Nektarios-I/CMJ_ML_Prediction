...
from jump_regressor.models import get_estimators, get_param_grid
...
def main() -> None:
    ...
    for name, estimator in get_estimators().items():
        ...
        best_model, best_params, _ = train_with_grid_search(estimator, get_param_grid(name), X_train, prepared.y_train)
